...
public class UserIT {
  ...
  public void testFindConnectedUsersAsAdmin() throws Exception {
    ...
    MvcResult result =
        mockMvc.perform(get("/users").with(user(admin))).andExpect(status().isOk()).andReturn();
  ...
  public void testFindConnectedUsersAsNonAdmin() throws Exception {
    ...
    mockMvc.perform(get("/users").with(user(regularUser))).andExpect(status().isForbidden());
  }
  ...
  public void testGetCurrentUser() throws Exception {
    ...
    MvcResult result =
        mockMvc.perform(get("/me").with(user(regularUser))).andExpect(status().isOk()).andReturn();
  ...
  public void testDeleteUser() throws Exception {
    ...
    MvcResult result =
        mockMvc
            .perform(delete("/me").with(user(regularUser)))
            .andExpect(status().isOk())
            .andReturn();
