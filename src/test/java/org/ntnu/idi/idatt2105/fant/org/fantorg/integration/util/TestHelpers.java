...
public class TestHelpers {
  ...
  public static String loginAndGetToken(
      TestRestTemplate restTemplate, String baseUrl, String email, String password) {
    UserLoginDto loginDto = new UserLoginDto(email, password);
    ResponseEntity<JwtTokenDto> response =
        restTemplate.postForEntity(baseUrl + "/auth/login", loginDto, JwtTokenDto.class);
  ...
  public static void registerUser(
    ...
    ResponseEntity<Void> response =
        restTemplate.postForEntity(baseUrl + "/auth/register", registerDto, Void.class);
  ...
  public static Long createCategoryAndSubcategory(
      TestRestTemplate restTemplate,
      String baseUrl,
      String categoryName,
    ...
    ResponseEntity<CategoryDto> subCategoryResponse =
        restTemplate.exchange(
