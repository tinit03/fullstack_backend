...
public class JwtService {
  ...
  public String generateToken(
    ...
    return Jwts.builder()
        ...
        .expiration(
            new Date(
                System.currentTimeMillis() + Duration.ofMinutes(expirationTimeMinutes).toMillis()))
        .signWith(key)
        .compact();
  }
  ...
  /**
   * Applies input function on the claims. The returned type depends on the type T of the input
   * function
   *
   * @param token Token
