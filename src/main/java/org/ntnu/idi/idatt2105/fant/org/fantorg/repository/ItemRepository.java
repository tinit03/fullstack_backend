 ...
 * and {@link JpaSpecificationExecutor} for more advanced querying of items in the database.
 */
@Repository
public interface ItemRepository extends JpaRepository<Item, Long>, JpaSpecificationExecutor<Item> {

    /**
     * Finds a page of {@link Item} records by item title.
     * This method retrieves items by their title, which must match exactly the provided item name.
     *
    ...
    /**
     * Finds a page of {@link Item} records by seller.
     * This method retrieves items listed by a specific seller.
     *
    ...
    /**
     * Finds a page of {@link Item} records that contain the provided keyword in their title
     * and belong to the specified subcategory.
     * This method performs a case-insensitive search for items matching the keyword in their title
    ...
    /**
     * Finds a page of {@link Item} records belonging to a specific subcategory.
     * This method retrieves items that belong to the specified subcategory.
     *
     * @param category the subcategory of the items to be searched
     * @param pageable the pagination information
