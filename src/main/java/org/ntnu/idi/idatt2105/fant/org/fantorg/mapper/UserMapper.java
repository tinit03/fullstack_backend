 ...
 * <p>
 * The UserMapper class provides methods to map User entities to UserDto objects for general
 * user information, and ChatProfileDto objects for representing a user in the context of a chat.
 * </p>
 */
public class UserMapper {
   ...
   * <p>
   * This method maps the essential user details (id, email, full name, first name, last name,
   ...
   * <p>
   * This method is specifically designed to map user information (full name and profile picture URL)
   * for the purpose of displaying a user's profile in the context of a chat.
   * </p>
   *
   * @param user The User entity to be converted.
   ...
   * <p>
   * This method converts each User entity in the list into a corresponding UserDto and
