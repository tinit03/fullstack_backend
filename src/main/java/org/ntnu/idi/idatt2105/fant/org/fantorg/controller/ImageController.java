...
//   */
//  @PostMapping("/{itemId}")
//  public ResponseEntity<ImageItemDto> uploadImage(@PathVariable Long itemId,
//      @Validated @RequestBody ImageItemUploadDto imageDto) {
//    ImageItemDto savedImage = imageService.saveImage(imageDto, itemId);
//
...
//  public ResponseEntity<List<ImageItemDto>> getImagesByItem(@PathVariable Long itemId) {
//    List<ImageItemDto> images = imageService.getImagesByItemId(itemId);
