 ...
 *
 * <p>This DTO is used to capture the necessary information required for placing a bid on an item.
...
public class BidCreateDto {
   ...
   * The bid amount.
   *
   * <p>This field is required and must be a value greater than {@code 0.00}. The {@link DecimalMin}
   * annotation enforces that the amount is at least {@code 0.01}.
   */
