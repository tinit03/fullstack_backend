 ...
 * and additional methods for managing {@link Category} records in the database.
 */
@Repository
public interface CategoryRepository extends JpaRepository<Category, Long> {

    /**
     * Finds a list of {@link Category} records that are children of a given parent category.
     * This method retrieves all categories that have the specified parent category.
     *
