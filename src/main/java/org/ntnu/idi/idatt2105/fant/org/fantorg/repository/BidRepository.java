 ...
 * interacting with the database such as saving, deleting, and finding {@link Bid}
 * objects. Custom query methods can also be defined here.
 *
 * @author Tini Tran
 * @since 1.0
 */
public interface BidRepository extends JpaRepository<Bid, Long> {
    ...
    /**
     * Finds a list of {@link Bid} entities associated with a particular item.
     * This method queries the database for all bids placed on the item with the
     * specified {@code id}.
     *
