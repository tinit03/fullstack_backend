 ...
 * and additional methods for managing {@link Bookmark} records in the database.
 */
public interface BookmarkRepository extends JpaRepository<Bookmark, Long> {

    /**
     * Finds a page of {@link Bookmark} records for a specific {@link User}.
     * This method allows for pagination and returns a subset of bookmarks associated with a user.
     *
    ...
    /**
     * Finds a set of all {@link Bookmark} records for a specific {@link User}.
     * This method returns all bookmarks associated with the given user, without pagination.
     *
     * @param user the {@link User} whose bookmarks are being fetched
    ...
    /**
     * Finds a {@link Bookmark} record for a specific {@link User} and {@link Item}.
     * This method returns an {@link Optional} of a bookmark, which may be empty if no matching
     * bookmark exists for the given user and item.
     *
    ...
    /**
     * Checks if a {@link Bookmark} exists for a specific {@link User} and {@link Item}.
     * This method returns a boolean indicating whether a bookmark for the given user and item exists.
     *
    ...
    /**
     * Deletes a {@link Bookmark} for a specific {@link User} and {@link Item}.
     * This method removes the bookmark from the database based on the given user and item.
     *
