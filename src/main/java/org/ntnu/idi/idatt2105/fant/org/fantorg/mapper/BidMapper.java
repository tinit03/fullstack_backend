 ...
 *
 * <p>The BidMapper class helps convert between the Bid entity and its corresponding Data Transfer
 * Object (DTO), and also facilitates creating a Bid object from a BidCreateDto.
 */
public class BidMapper {
   ...
   *
   * <p>This method maps the relevant fields of the Bid entity to a BidDTO. The BidDTO is used to
   * transfer data about the bid in a non-persistent format.
   *
   ...
   *
   * <p>This method creates a new Bid object based on the provided BidCreateDto, setting the
   * relevant fields and assigning default values where necessary.
   *
