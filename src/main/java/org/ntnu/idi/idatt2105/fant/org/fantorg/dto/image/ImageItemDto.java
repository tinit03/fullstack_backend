 ...
 * <p>
 * This DTO is used to transfer the image's details, such as its URL, caption, and public identifier.
 * It is typically used when displaying images related to an item in the application.
 * </p>
 */
@Getter
@Setter
public class ImageItemDto {
   ...
   * <p>
   * This field contains the URL pointing to the image resource. It is used to retrieve
   * and display the image in the application.
   * </p>
   */
  private String url;
   ...
   * <p>
   * This field contains the unique identifier assigned to the image in the cloud storage system.
