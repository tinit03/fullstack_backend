 ...
 * for {@link Notification} and custom queries for notifications associated with a user.
 */
public interface NotificationRepository extends JpaRepository<Notification, Long> {

    /**
     * Finds a page of {@link Notification} records by recipient.
     * This method retrieves notifications sent to the specified recipient, with pagination support.
     *
    ...
    /**
     * Finds a list of {@link Notification} records by recipient.
     * This method retrieves all notifications sent to the specified recipient without pagination.
     *
     * @param recipient the user who is the recipient of the notifications
