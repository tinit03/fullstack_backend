 ...
 * for {@link PasswordResetToken} entities, including token-based operations
...
public interface PasswordResetTokenRepository extends JpaRepository<PasswordResetToken, Long> {
     ...
     * @return an {@link Optional} containing the {@link PasswordResetToken} if found, otherwise empty.
     */
