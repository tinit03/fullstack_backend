...
/**
 * Repository interface for managing {@link ChatRoom} entities.
 * This interface extends {@link JpaRepository} to provide basic CRUD operations
 * and additional methods for querying {@link ChatRoom} records in the database.
 */
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {

    /**
     * Finds a {@link ChatRoom} based on the sender, recipient, and associated item.
     * This method retrieves a chat room between two users related to a specific item.
     *
     ...
     * @return an {@link Optional} containing the {@link ChatRoom} if found, or empty if no chat room exists
     */
    Optional<ChatRoom> findBySenderAndRecipientAndItem(User sender, User recipient, Item item);

    /**
     * Finds a paginated list of {@link ChatRoom} records for a specific sender.
     * This method retrieves all chat rooms initiated by a specific user (sender).
     *
    ...
    /**
     * Finds a list of {@link ChatRoom} records based on a list of chat IDs.
     * This method retrieves chat rooms with the specified chat IDs.
     *
