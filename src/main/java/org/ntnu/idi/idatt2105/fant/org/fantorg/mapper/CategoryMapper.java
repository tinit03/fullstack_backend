...
/**
 * A utility class for mapping between Category and SubCategory entities and their corresponding
 * DTOs.
 *
 * <p>The CategoryMapper class provides methods for converting between Category entities and
 * CategoryDto objects, as well as for converting SubCategory entities and SubCategoryDto objects.
 */
public class CategoryMapper {
   ...
   *
   * <p>This method maps the relevant fields of the Category entity, including its subcategories, to
   * a CategoryDto for data transfer.
   *
  ...
  public static CategoryDto toCategoryDto(Category category) {
    ...
    List<SubCategoryDto> subDtos =
        category.getSubCategories().stream().map(CategoryMapper::toSubCategoryDto).toList();
   ...
   *
   * <p>This method maps only the parent category fields of the Category entity, without considering
   * subcategories.
   *
   * @param category The Category entity to be converted.
   ...
   *
   * <p>This method maps the relevant fields of the SubCategory entity to a SubCategoryDto.
   *
   ...
   *
   * <p>This method creates a new Category entity from the provided CategoryDto, setting the
   * category name.
   *
  ...
  /**
   * Converts a SubCategoryCreateDto to a SubCategory entity, with a reference to the parent
   * category.
   *
   * <p>This method creates a new SubCategory entity from the provided SubCategoryCreateDto, and
   * assigns the provided parentCategory as its parent.
   *
  ...
  /**
   * Converts a list of Category entities to a list of CategoryDto objects, including only parent
   * categories (no subcategories).
   *
   * <p>This method filters the provided categories to include only parent categories (i.e.,
   * categories without a parent category), and maps them to CategoryDto objects.
   *
   ...
   *
   * <p>This method filters the provided categories to include only subcategories (i.e., categories
   * with a parent category), and maps them to SubCategoryDto objects.
   *
   * @param categories The list of Category entities to be converted.
