...
public class NotificationController {
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "204", description = "Notification marked as read successfully", content=@Content)
  })
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "204", description = "All notifications deleted successfully", content = @Content)
  })
  @DeleteMapping("/me")
