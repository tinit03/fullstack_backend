 ...
 *
 * <p>The ReviewMapper class provides methods to map Review entities to ReviewDto and
...
public class ReviewMapper {
   ...
   *
   * <p>This method maps all relevant fields from the Review entity to a ReviewDto, which is used to
   * represent review details in a response.
   *
  ...
  public static ReviewDto toDto(Review review) {
    ...
    dto.setBuyerName(
        review.getOrder().getBuyer().getFirstName()
            + " "
            + review.getOrder().getBuyer().getLastName());
    dto.setSellerName(
        review.getOrder().getItem().getSeller().getFirstName()
            + " "
            + review.getOrder().getItem().getSeller().getLastName());
   ...
   *
   * <p>This method maps the information from the ReviewCreateDto to a new Review entity that can be
   * persisted in the database. The order will be set in the service layer.
   *
