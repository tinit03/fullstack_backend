 ...
 * and additional methods for querying {@link Image} records in the database.
 */
public interface ImageRepository extends JpaRepository<Image, Long> {

    /**
     * Finds a list of {@link Image} records associated with a specific item.
     * This method retrieves all images related to a particular item based on its ID.
     *
